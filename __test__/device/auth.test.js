...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Narciso89',
      password: 'CPxZlvdUGjKkj_g',
      email: 'Deborah_Reichert46@gmail.com',
      name: 'Francisco McLaughlin',
      userType: 386,
      mobileNo: '(589) 812-3226',
      resetPasswordLink: {},
      loginRetryLimit: 609,
      loginReactiveTime: '2022-05-28T19:56:58.758Z',
      id: '6241617244befc1725a0cde2'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Brad.Wunsch62',
        'password':'MACZduwz2Y3DZI5',
        'email':'Alexzander_Kilback63@gmail.com',
        'name':'Ernesto Williamson',
        'userType':authConstant.USER_TYPES.User,
        'mobileNo':'274-880-9463 x638',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Alexzander_Kilback63@gmail.com', });
