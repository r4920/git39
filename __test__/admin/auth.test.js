...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Dangelo_Bergstrom72',
      password: 'w37GB75b0l9T8Qw',
      email: 'Linnie87@yahoo.com',
      name: 'Julie Weissnat IV',
      userType: 700,
      mobileNo: '(209) 585-7989 x15303',
      resetPasswordLink: {},
      loginRetryLimit: 986,
      loginReactiveTime: '2022-05-15T11:47:07.458Z',
      id: '6241617244befc1725a0cdbe'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Seamus_Goyette',
        'password':'Jy8YhpMOy751nTd',
        'email':'Dakota.Keebler@hotmail.com',
        'name':'Mable O\'Hara',
        'userType':authConstant.USER_TYPES.Admin,
        'mobileNo':'867.660.7330 x9212',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Dakota.Keebler@hotmail.com', });
